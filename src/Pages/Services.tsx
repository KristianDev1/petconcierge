            ...
            <div class="w-full py-16 flex flex-wrap justify-center">
                ...
                <div class="w-10/12 flex flex-wrap sm:flex-nowrap gap-5 py-10">
                    ...
                    <div class="w-full sm:w-1/2">
                        ...
                        We run all the errands for you: To vet visits, play dates, training classes etc. We manage the bookings, payments and provide the transport. Pricing: Is determined by costs that may occur by the facilities that your fur baby has used or needed. All receipts will be kept for our proof of payment.
                        </p>
                    </div>
                </div>  
            </div>
